...
urlpatterns = [
    ...
    path('buscar_aeropuerto_pais/', views.pais_aerop_search, name="buscar_pais_aeropuerto"),
    path("buscar_aeropuerto_prov/", views.estado_aerop_search, name="buscar_prov_aeropuerto"),
]